...
function InternDetail() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await axios.get(`https://internareabackend-d07z.onrender.com/api/internship/${id}`)
  ...
  const submitApplication = async () => {
    ...
    if (text.value === "") {
      ...
      await axios.post("https://internareabackend-d07z.onrender.com/api/application", bodyJson).then((res) => {
      }).catch((err) => {
        alert("error happend")
      })
      alert("Done")
