...
//             <p onMouseEnter={showLanguageSwitcher}>Languagess  <i className="bi bi-caret-down-fill" id='ico4' onClick={hideLanguageSwitcher}></i></p>
//           </div>
//           <div className="search">
...
function Navbar() {
  ...
  const onOtpVerified = () => {
    console.log(i18n); // Check the i18n object
    console.log(typeof i18n.changeLanguage); // Check if changeLanguage is a function
  ...
  //   e.preventDefault();
  //   try {
  //     const response = await axios.post('http://localhost:5000/otp/verify', { contact, otp });
  //     if (response.data.success) {
  //       onOtpVerified();
  //     } else {
  //       alert(t('common.invalidOtp'));
  //     }
  //   } catch (error) {
